...
1. Create a new Automated ML job with the following settings, using **Next** as required to progress through the user interface:
    ...
    **Basic settings**:
    ...
    - **Description**: Automated machine learning for diabetes prediction
    - **Tags**: *none*
   ...
   **Task type & data**:
    ...
    - **Select dataset**: Create a new dataset with the following settings:
        - **Data type**:
            - **Name**: diabetes
            - **Description**: Historic diabetes data
            - **Type**: Tabular
        - **Data source**:
            - Select **From local files**
        - **Web URL**:
            - **Web URL**: [Diabetes Dataset](https://raw.githubusercontent.com/pmodheji/AI-900-AIFundamentals/refs/heads/main/data/ml/diabetes.csv)
    ...
    **Task settings**:
    ...
    - **Dataset**: diabetes
    - **Target column**: Diabetic (integer)
    ...
    - **Limits**: *Expand this section*
        ...
        - **Max nodes**: 3
        - **Metric score threshold**: 0.95 (*so that if a model achieves an accuracy score of 0.95 or more, the job ends.*)
        - **Timeout**: 15
